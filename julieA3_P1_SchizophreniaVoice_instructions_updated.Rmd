...
test$sd <- sd(first$time)
test$range <- range(first$time)
test$iqr <- IQR(first$time)
test$median <- median(first$time)
test$meanAD <- mad(first$time)
test$cv <- sd(first$time, na.rm = TRUE / mean(first$time, na.rm = TRUE))*100
