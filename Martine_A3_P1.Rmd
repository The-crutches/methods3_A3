...
#Clinical features 
  #Removing na's and thereby exluding study 3 and 4, since none of them has the clinical observations
...
pitch_variability <- lme4::lmer(pitch_IQR ~ 0 + Diagnosis + (1|ID), df)
summary(pitch_variability)

  #proportion of spoken time

proportion_spoken <- lme4::lmer(prop_spoken_time ~ 0 + Diagnosis + (1|ID), df)
summary(proportion_spoken)

  #speech rate

speech_rate <- lme4::lmer(speechrate..nsyll.dur. ~ 0 + Diagnosis + (1|ID), df)
summary(speech_rate)

  #pause duration

pause_duration <- lme4::lmer(pause_duration ~ 0 + Diagnosis + (1|ID), df)
